...
class ButtonComponent extends Component {
    ...
    renderButton({ textStyle = styles.text, imageStyle = styles.image }) {
        ...
        if (this.props.states) {
            ...
            button = ( <
                Button states = { addedAnimtionConfigButtonStates }
            ...
            button = ( <
                Button textStyle = { this.props.textStyle || textStyle }
                imageStyle = { this.props.imageStyle || imageStyle }
    ...
    render() {
        ...
        if (type === 'primary') {
            content = ( <
                LinearGradient start = { disabled ? disabledGradientStart : gradientStart }
                end = { disabled ? disabledGradientEnd : gradientEnd }
                colors = { backgroundColors }
                collapsable = { false }
                style = {
                    [styles.button, shapeStyle, buttonStyle, disabledStyle] } >
            ...
            content = ( <
                View style = {
                    [styles.button, border, shapeStyle, buttonStyle, disabledStyle] } > { this.renderButton({ textStyle: styles.secondaryText }) } <
                /View>
            );
        }
